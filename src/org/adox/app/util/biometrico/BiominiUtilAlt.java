...
public class BiominiUtilAlt extends JFrame {
...
//	private UFExtractorClass libExtract=null;
...
//			libExtract = (UFExtractorClass)Native.loadLibrary("UFExtractor",UFExtractorClass.class);
    ...
    private ImagePanel getImagePanel() {
        if (imgPanel == null) {
            ...
            imgPanel.setBounds(new Rectangle(260, 17, 222, 287));
    ...
    private JComboBox getJComboBox_timeout() {
        if (jComboBox_timeout == null) {
            ...
            jComboBox_timeout.setBounds(new Rectangle(90, 195, 50, 23));
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    ...
                    if (hScanner != null) {
                        ...
                        if (nRes == 0) {
                            ...
                            setStatusMsg("UFS_Extract success!! size:" + refTemplateSize.getValue() + "quality:" + refTemplateQuality.getValue());

                        } else {
                            setStatusMsg("UFS_Extract fail!! code:" + nRes);
                        ...
                        setStatusMsg("UFS_Extract fail!! get current scanner handle fail!");
                    }
                }
            });
        ...
        if (jComboBox_enroll == null) {
            ...
            jComboBox_enroll.addActionListener(new java.awt.event.ActionListener() {
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    ...
                    MsgBox((String) (jComboBox_enroll.getSelectedItem()));
        ...
        if (jButton_save_tmp == null) {
            ...
            jButton_save_tmp.addActionListener(new java.awt.event.ActionListener() {
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    ...
                    int returnVal = fc.showSaveDialog(BiominiUtilAlt.this);
    ...
    private JComboBox getJComboBox_bri() {
        if (jComboBox_bri == null) {
            ...
            jComboBox_bri.setBounds(new Rectangle(90, 221, 50, 23));
    ...
    private JComboBox getJComboBox_sens() {
        if (jComboBox_sens == null) {
            ...
            jComboBox_sens.setBounds(new Rectangle(90, 248, 50, 23));
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                BiominiUtilAlt thisClass = new BiominiUtilAlt();
    ...
    private void initialize() {
        this.setSize(504, 601);
        this.setContentPane(getJContentPane());
        this.setTitle("Suprema PC SDK 3.1 Demo (JAVA SWING)");
        this.setContentPane(getJContentPane());
    }
    ...
    private JPanel getJContentPane() {
        if (jContentPane == null) {
            ...
            jLabel_sense.setBounds(new Rectangle(24, 248, 62, 18));
            jLabel_sense.setText("Sensitivity");
            jLabel_brightness = new JLabel();
            jLabel_brightness.setBounds(new Rectangle(23, 220, 62, 18));
            jLabel_brightness.setText("Birghtness");
            jLabel_timeout = new JLabel();
            jLabel_timeout.setBounds(new Rectangle(23, 197, 46, 18));
